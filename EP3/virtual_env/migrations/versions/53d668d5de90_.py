...
Revision ID: 53d668d5de90
Revises: 
Create Date: 2019-07-02 09:23:34.447505
...
def upgrade():
    ...
    op.drop_constraint('sk_pessoa', 'b01_pessoa', type_='unique')
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_unique_constraint('sk_pessoa', 'b01_pessoa', ['pes_cpf'])
    ...
    sa.Column('al_id', sa.INTEGER(), server_default=sa.text("nextval('b03_aluno_al_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.Column('us_id', sa.INTEGER(), server_default=sa.text("nextval('users_us_id_seq'::regclass)"), autoincrement=True, nullable=False),
